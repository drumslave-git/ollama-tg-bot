...
export async function buildSettingsPayload() {
  ...
  return {
    ...
    embeddingApiKeyConfigured: config.embeddingApiKey.length > 0,
    embeddingHostDistinct: config.embeddingHostDistinct,
    imageBaseUrl: config.imageBaseUrl,
    imageApiKeyConfigured: config.imageApiKey.length > 0,
    imageHostDistinct: config.imageHostDistinct,
