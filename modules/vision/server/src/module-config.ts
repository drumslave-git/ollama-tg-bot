...
export const DEFAULT_VISION_MODULE_CONFIG: VisionModuleConfig = {
...
export function validateVisionModuleConfig(
  partial: Partial<VisionModuleConfig>,
): VisionModuleConfig {
  const backfillDebounceSec =
    partial.backfillDebounceSec ?? DEFAULT_VISION_MODULE_CONFIG.backfillDebounceSec;
  if (
