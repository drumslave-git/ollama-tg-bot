export function formatLinkFetchContext(pages) {
    const parts = [
...
export function formatLinkFetchFailure(urls, err) {
    const detail = err instanceof Error ? err.message : String(err);
    const list = urls.join(", ");
    return (`The message included link(s) (${list}) but Playwright could not fetch them: ${detail}\n\n` +
