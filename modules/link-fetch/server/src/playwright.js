...
const USER_AGENT = "Mozilla/5.0 (compatible; LLMTGBot/1.0; +https://github.com/llm-tg-bot)";
let browser = null;
...
async function fetchOnePage(context, url) {
...
export async function fetchPagesWithPlaywright(urls, maxUrls = DEFAULT_MAX_URLS_PER_TURN) {
